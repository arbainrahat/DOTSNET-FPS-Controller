...
namespace DOTSNET
{
    ...
    public class ConnectionState
    {
        ...
        // batches
        // Dictionary<Channel, batch> because we have multiple channels.
        public Dictionary<Channel, Batch> batches;

        public ConnectionState(int MaxMessageSize, double currentTime)
        {
            // create batches for both channels
            batches = new Dictionary<Channel, Batch> {
                { Channel.Reliable, new Batch(MaxMessageSize, currentTime) },
                { Channel.Unreliable, new Batch(MaxMessageSize, currentTime) },
            };
        }
    }
}