    ...
    public class AutoJoinWorldSystem : SystemBase
    {
        ...
        bool FindFirstRegisteredPrefab(out Bytes16 prefabId, out Entity prefab)
        {
            foreach (KeyValuePair<Bytes16, Entity> kvp in prefabSystem.prefabs)
            {
             ...
             //  Debug.Log( "PrefabSystem Translation ="+prefabSystem.GetComponentDataFromEntity<Unity.Transforms.Translation>());
                return true;
            }
        ...
        protected override void OnStartRunning()
        {
            ...
            {
                //Get Spawnable Player prefab Entity For Camera Follow
                playerPrefabEntity = prefab;
